    ...
    for data_folder in data_folders:
        ...
        if split_speaker:
            ...
            for f in glob.glob(path, recursive=True):
                splitter="\\"
                spk_id = f.split(splitter+"wav"+splitter)[1].split(splitter)[0]
...
if __name__ == "__main__":
    data_folder = "C:/ZHAW/BA/VoxCeleb/one/train_dir"
    verification_pairs_file = data_folder+"/veri_test.txt"
    prepare_voxceleb(data_folder, data_folder, verification_pairs_file)
