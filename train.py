...
class Task(LightningModule):
    def __init__(
        ...
        **kwargs
        ...
        # TODO fix RuntimeError: mat1 and mat2 shapes cannot be multiplied (6240x252 and 80x252)
        ...
        # ODO fix RuntimeError: mat1 and mat2 shapes cannot be multiplied (6240x252 and 80x252)
